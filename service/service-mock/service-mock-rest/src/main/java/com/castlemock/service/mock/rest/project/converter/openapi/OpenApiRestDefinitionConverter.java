...
/**
 * The {@link OpenApiRestDefinitionConverter} provides Swagger related functionality.
 *
...
public class OpenApiRestDefinitionConverter extends AbstractRestDefinitionConverter {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(OpenApiRestDefinitionConverter.class);
    ...
    private RestMethod createRestMethod(final Operation operation,
        ...
        if(!operation.getResponses().isEmpty()){
            Collection<RestMockResponse> mockResponses = null;
            try {
                mockResponses = generateResponse(operation.getResponses());
            } catch (IOException e) {
                e.printStackTrace();
            }
     ...
     */
    private Collection<RestMockResponse> generateResponse(final ApiResponses responses) throws IOException {
        if(responses == null){
